...
// index.html and return those elements. (Note that we're using the plural
// because the selector will always return an array when used with tags, even
// if there's only one!)
...
// The function should use a class selector to return the two divs with the
// class pics.
